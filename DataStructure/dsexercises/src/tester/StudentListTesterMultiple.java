		 ...
		 for (int i = 0; i < 2; i++) {
			...
			//store student object in studentlist 
			 ...
			 for (Student student2 : studentlist) {
				 ...
				 System.out.println("Student lastname"+ (i+1) +" "+student2.getLastname());
				 System.out.println("Student firstname"+ (i+1) +" "+student2.getFirstname());
				 System.out.println("Student progid"+ (i+1) +" "+student2.getProgramID());
			 }
		}
